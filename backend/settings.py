...
class _UiSettings(BaseSettings):
    ...
    chat_description: str = "Your AI-powered assistant, here to help with general People queries, policies, and guidance."
...
class _AzureSearchSettings(BaseSettings, DatasourcePayloadConstructor):
    ...
    endpoint_suffix: str = Field(default="privatelink.search.windows.net", exclude=True)
